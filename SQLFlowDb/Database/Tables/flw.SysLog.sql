...
GO
ALTER TABLE [flw].[SysLog] ADD CONSTRAINT [PK_SysLog] PRIMARY KEY CLUSTERED ([FlowID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_EndTime] ON [flw].[SysLog] ([EndTime]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[SysLog] ([FlowID]) INCLUDE ([Success], [EndTime]) ON [PRIMARY]
GO
