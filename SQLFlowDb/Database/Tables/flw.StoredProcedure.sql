...
FROM inserted;
GO
ALTER TABLE [flw].[StoredProcedure] ADD CONSTRAINT [PK_PrePostSP] PRIMARY KEY CLUSTERED ([FlowID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[StoredProcedure] ([FlowID]) INCLUDE ([Batch], [SysAlias], [DeactivateFromBatch]) ON [PRIMARY]
GO
