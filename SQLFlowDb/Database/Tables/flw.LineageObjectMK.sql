...
GO
ALTER TABLE [flw].[LineageObjectMK] ADD CONSTRAINT [PK_ObjectMK] PRIMARY KEY CLUSTERED ([ObjectMK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_ObjectMK] ON [flw].[LineageObjectMK] ([ObjectMK]) INCLUDE ([ObjectType]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_SysAliasObjectName] ON [flw].[LineageObjectMK] ([SysAlias], [ObjectName]) ON [PRIMARY]
GO
