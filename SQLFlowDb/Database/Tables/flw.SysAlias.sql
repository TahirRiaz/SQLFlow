...
GO
ALTER TABLE [flw].[SysAlias] ADD CONSTRAINT [PK_SysAlias] PRIMARY KEY CLUSTERED ([SystemID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [NCI_SystemAlias] ON [flw].[SysAlias] ([SysAlias]) ON [PRIMARY]
GO
