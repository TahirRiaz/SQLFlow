...
GO
ALTER TABLE [flw].[SysLogExport] ADD CONSTRAINT [PK_SysLogExport] PRIMARY KEY CLUSTERED ([RecID]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[SysLogExport] ([FlowID]) ON [PRIMARY]
GO
