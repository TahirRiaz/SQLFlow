...
GO
ALTER TABLE [flw].[SysAPIKey] ADD CONSTRAINT [PK_APIKeyID] PRIMARY KEY CLUSTERED ([ApiKeyID]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [NCI_SysAPIKey] ON [flw].[SysAPIKey] ([ApiKeyAlias]) ON [PRIMARY]
GO
