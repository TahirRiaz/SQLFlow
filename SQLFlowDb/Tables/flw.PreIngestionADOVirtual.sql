...
GO
ALTER TABLE [flw].[PreIngestionADOVirtual] ADD CONSTRAINT [PK_PreIngestionADOVirtual] PRIMARY KEY CLUSTERED ([VirtualID])
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[PreIngestionADOVirtual] ([FlowID])
GO
