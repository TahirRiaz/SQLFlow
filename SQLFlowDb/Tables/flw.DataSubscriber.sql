...
FROM inserted;
GO
ALTER TABLE [flw].[DataSubscriber] ADD CONSTRAINT [PK_DataSubscriber] PRIMARY KEY CLUSTERED ([FlowID])
GO
CREATE NONCLUSTERED INDEX [NCI_SubscriberName] ON [flw].[DataSubscriber] ([SubscriberName])
GO
