...
GO
ALTER TABLE [flw].[IngestionVirtual] ADD CONSTRAINT [PK_IngestionVirtual] PRIMARY KEY CLUSTERED ([VirtualID])
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[IngestionVirtual] ([FlowID])
GO
