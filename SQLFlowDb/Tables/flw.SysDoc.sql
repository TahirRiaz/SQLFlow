...
GO
ALTER TABLE [flw].[SysDoc] ADD CONSTRAINT [PK_SysDocID] PRIMARY KEY CLUSTERED ([SysDocID])
GO
CREATE UNIQUE NONCLUSTERED INDEX [NIC_UNIQUE_ObjectName] ON [flw].[SysDoc] ([ObjectName])
GO
