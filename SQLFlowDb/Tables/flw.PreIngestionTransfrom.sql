...
GO
ALTER TABLE [flw].[PreIngestionTransfrom] ADD CONSTRAINT [PK_PreIngestionTransfrom] PRIMARY KEY CLUSTERED ([TransfromID])
GO
CREATE NONCLUSTERED INDEX [NCI_ColNameClean] ON [flw].[PreIngestionTransfrom] ([ColNameClean])
GO
CREATE NONCLUSTERED INDEX [NCI_FlowID] ON [flw].[PreIngestionTransfrom] ([FlowID], [FlowType], [ColName])
GO
CREATE UNIQUE NONCLUSTERED INDEX [NCI_UniqueColumnName] ON [flw].[PreIngestionTransfrom] ([FlowID], [FlowType], [ColName])
GO
