...
{
    public partial class EditSurrogateKey
    {
        [Inject]
        ...
        {
            surrogateKey = await sqlflowProdService.GetSurrogateKeyBySurrogateKeyId(SurrogateKeyID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdateSurrogateKey(SurrogateKeyID, surrogateKey);
