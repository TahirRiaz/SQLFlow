...
{
    public partial class AddPreIngestionADOVirtual
    {
        [Inject]
        ...
        {
            preIngestionADOVirtual = new SQLFlowUi.Models.sqlflowProd.PreIngestionADOVirtual();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.CreatePreIngestionADOVirtual(preIngestionADOVirtual);
