...
{
    public partial class EditDataSubscriberQuery
    {
        [Inject]
        ...
        {
            dataSubscriberQuery = await sqlflowProdService.GetDataSubscriberQueryByQueryID(QueryID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdateDataSubscriberQuery(QueryID, dataSubscriberQuery);
