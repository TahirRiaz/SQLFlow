...
{
    public partial class EditPreIngestionPRQ
    {
        [Inject]
        ...
        {
            preIngestionPRQ = await sqlflowProdService.GetPreIngestionPRQByFlowId(FlowID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdatePreIngestionPRQ(FlowID, preIngestionPRQ);
