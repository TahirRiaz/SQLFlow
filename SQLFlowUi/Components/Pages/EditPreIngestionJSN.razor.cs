...
{
    public partial class EditPreIngestionJSN
    {
        [Inject]
        ...
        {
            preIngestionJSN = await sqlflowProdService.GetPreIngestionJSNByFlowId(FlowID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdatePreIngestionJSN(FlowID, preIngestionJSN);
