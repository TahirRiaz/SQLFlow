...
{
    public partial class EditHealthCheck
    {
        [Inject]
        ...
        {
            healthCheck = await sqlflowProdService.GetHealthCheckByHealthCheckId(HealthCheckID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdateHealthCheck(HealthCheckID, healthCheck);
