...
{
    public partial class EditMatchKey
    {
        [Inject]
        ...
        {
            matchKey = await sqlflowProdService.GetMatchKeyByMatchKeyId(MatchKeyID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                ...
                await sqlflowProdService.UpdateMatchKey(MatchKeyID, matchKey);
