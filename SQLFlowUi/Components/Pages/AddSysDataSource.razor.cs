...
{
    public partial class AddSysDataSource
    {
        [Inject]
        ...
        {
            sysDataSource = new SQLFlowUi.Models.sqlflowProd.SysDataSource();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.CreateSysDataSource(sysDataSource);
