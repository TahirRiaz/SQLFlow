...
{
    public partial class EditPreIngestionPRC
    {
        [Inject]
        ...
        {
            preIngestionPRC = await sqlflowProdService.GetPreIngestionPRCByFlowId(FlowID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await sqlflowProdService.UpdatePreIngestionPRC(FlowID, preIngestionPRC);
