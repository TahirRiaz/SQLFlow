...
namespace SQLFlowUi.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SQLFlowUi.Models.ApplicationUser> users;
        protected RadzenDataGrid<SQLFlowUi.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SQLFlowUi.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SQLFlowUi.Models.ApplicationUser user)
        {
            try
            {
