...
(function () {
    ...
    BlazorAudioRecorder.GetBlobLink = async function (language, translate, dotNetRef) {
        // Create a link element

        console.log("start");
        const arrayBuffer = await AudioBlob.arrayBuffer();
        const byteArray = new Uint8Array(arrayBuffer);
        await dotNetRef.invokeMethodAsync('ReceiveBlob', language, translate, byteArray);
