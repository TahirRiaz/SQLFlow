...
/// conditional update, insert or select; every fence lives in the store it delegates to.
/// </summary>
public sealed class CatalogDispatchLedger : IDispatchLedger
{
    ...
    public Task<bool> MarkRunHandedOutAsync(Guid runId, int expectedAttempt, string node, DateTime nowUtc, CancellationToken ct)
    ...
    public Task<bool> MarkTaskHandedOutAsync(Guid taskId, string node, DateTime nowUtc, CancellationToken ct)
